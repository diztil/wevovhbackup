...
function onYouTubeIframeAPIReady() {
  ...
  var r = new YT.Player("youtube-player", { height: "0", width: "0", videoId: "yinAK4FO4ck", playerVars: { autoplay: e.dataset.autoplay, loop: e.dataset.loop }, events: { onReady: function(e) { r.setPlaybackQuality("small"), o(r.getPlayerState() !== YT.PlayerState.CUED) }, onStateChange: function(e) { e.data === YT.PlayerState.ENDED && o(!1) } } })
};